# Cleanup Checklist: Exercise 7 - Config and Secrets on EKS

Mandatory - do not start the next exercise until every box below is checked.

- [ ] `kubectl get all,configmap,secret` in your namespace shows nothing left from this exercise (aside from the default kubernetes ConfigMap/Secrets that always exist)
