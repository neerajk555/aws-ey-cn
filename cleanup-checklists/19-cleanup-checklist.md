# Cleanup Checklist: Exercise 19 - Container Insights and Managed Prometheus

Mandatory - do not start the next exercise until every box below is checked.

- [ ] `kubectl get all` in your namespace shows nothing left from this exercise
- [ ] No cleanup needed for the monitoring infrastructure itself - it's shared and instructor-owned, not yours to delete
