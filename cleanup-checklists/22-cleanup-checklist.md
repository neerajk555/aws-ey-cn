# Cleanup Checklist: Exercise 22 - SSM Parameter Store

Mandatory - do not start the next exercise until every box below is checked.

- [ ] Both parameters under `/course/$PARTICIPANT/` deleted (`aws ssm get-parameters-by-path --path "/course/$PARTICIPANT" --region us-east-1` shows nothing)
