# Cleanup Checklist: Exercise 12 - Deploy a Helm Chart to EKS

Mandatory - do not start the next exercise until every box below is checked.

- [ ] `helm list` in your namespace shows nothing left from this exercise
- [ ] `kubectl get all` confirms no orphaned resources
